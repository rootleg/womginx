...
**Before you deploy to Railway, read the following: Railway decided that this repository violates the ToS, so directly clicking the button below if you're in the main repository will result in an error. Forked repositories may work, though this is not guaranteed. Regardless, I am NOT responsible if your Railway account gets suspended because of deploying this application. Proceed at your own risk.**
